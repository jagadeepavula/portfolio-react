...
function Socials() {
  ...
  const handleGmailClick = () => {
    ...
    const body = encodeURIComponent(
      "Hey, Congratulations on taking the plunge and clicking that button! Whether you're just here to test if it works (spoiler: it does) or if you've got something exciting like a job opportunity or a project in mind, I'm all in."
    );
  ...
  return (
    <div
      id="socials"
      className="the-whole-section flex flex-col h-auto w-full items-center justify-center mb-10"
    >
      <div className="section-with-width grid lg:grid-cols-10 grid-cols-1 h-auto w-5/6 justify-center items-center ">
        <div className="left-section lg:col-span-6 lg:mr-5">
          <span className="font-extrabold text-customText xl:text-9xl lg:text-8xl md:text-7xl text-6xl tracking-tighter">
            Social
          </span>
          <br />
          <span className="font-extrabold text-customText xl:text-9xl lg:text-8xl md:text-7xl text-6xl tracking-tighter ">
          ...
          <span className="justify-center items-center ">
            <h4 className="text-md text-customText font-light mt-2 mb-4 text-justify leading-5 lg:leading-6 ">
              Click 'Resume' for the whole portfolio in one PDF. If it fits a
        ...
        <div className="right-section lg:col-span-4 ">
          <div className="w-full" style={{ height: "calc(6 * 87px)" }}>
            <motion.div
              className="card1 grid grid-cols-10 w-full bg-customLinkedin h-28 rounded-xl justify-center items-center shadow-2xl"
            ...
            >
              ...
              <h1 className="col-span-7 ml-7 md:text-4xl text-3xl text-customLinkedinFont font-extrabold items-center justify-center ">
                LinkedIn
              </h1>
            </motion.div>
            <motion.div
              className="card2  w-full h-28 bg-customVanilla rounded-xl z-5 grid grid-cols-10 justify-between items-center shadow-2xl"
              whileHover={{ translateY: -40 }}
              style={{ zIndex: 1, translateY: -30 }}
            ...
            >
              ...
              <h1 className="col-span-7 ml-7 text-customVanillaFont md:text-4xl text-3xl font-extrabold">
                Dribbble
              </h1>
            </motion.div>
            <motion.div
              className="card3  w-full h-28  bg-customGithub rounded-xl z-5 grid grid-cols-10 justify-between items-center shadow-2xl"
              whileHover={{ translateY: -70 }}
              style={{ zIndex: 2, translateY: -60 }}
            ...
            >
              ...
              <h1 className="col-span-7 ml-7 md:text-4xl text-3xl text-customGithubFont font-extrabold">
                Github
              </h1>
            </motion.div>
            <motion.div
              className="card4  w-full h-28 bg-customFiling rounded-xl z-5 grid grid-cols-10 justify-between items-center shadow-2xl"
              whileHover={{ translateY: -100 }}
              style={{ zIndex: 3, translateY: -90 }}
            ...
            >
              ...
              <h1 className="col-span-7 ml-7 text-customFilingFont md:text-4xl text-3xl font-extrabold">
                Instagram
              </h1>
            </motion.div>
            <motion.div
              className="card5  w-full h-28 bg-customInsta rounded-xl z-5 grid grid-cols-10 justify-between items-center shadow-2xl"
              whileHover={{ translateY: -130 }}
              style={{ zIndex: 4, translateY: -120 }}
            ...
            >
              ...
              <h1 className="col-span-7 ml-7 text-customInstaFont md:text-4xl text-3xl font-extrabold">
                Gmail
              </h1>
            </motion.div>
            <motion.div
              className="card6 w-full h-28 bg-customYellow rounded-xl z-5 grid grid-cols-10 justify-between items-center shadow-2xl"
              whileHover={{ translateY: -160 }}
              style={{ zIndex: 5, translateY: -150 }}
            ...
            >
              ...
              <h1 className="col-span-7 ml-7 text-customYellowFont md:text-4xl text-3xl font-extrabold">
                Resume
              </h1>
            </motion.div>
          </div>
