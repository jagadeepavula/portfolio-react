...
function Defaced() {
  const handleInstagramRedirect = () => {
    window.open(
      "https://www.instagram.com/defaced_artistry?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
      "_blank"
    );
  };
  ...
  return (
    <div
      id="Defaced"
      className="relative h-auto flex items-center w-screen justify-center top-0 mt-40 mb-60 "
    >
      <div className="w-screen h-auto flex flex-col items-center ">
        <div className="title mb-10 ">
          <div className="flex flex-row items-center justify-center">
            <img
              src={Deface}
              alt=""
              className="object-cover mr-5 h-auto w-16"
            ></img>
        ...
        <div className="buttons mb-20">
          <GrootButton
            ...
            initialText="I'm Groot"
            hoverText="Visit Page"
          />
        </div>

        <div className=" grid grid-rows-3 cardParent h-auto w-auto">
          <div className="flex flex-row items-center justify-center md:space-x-20">
            ...
            >
              <div className="p-5 flex flex-col h-full justify-between">
                <h2 className="lg:text-4xl text-2xl font-bold text-customCard1font">
                  The <br />
                  Weeknd
                </h2>
                <img
            ...
            >
              <div className="p-5 flex flex-col h-full justify-between">
                <h2 className="lg:text-4xl text-2xl font-bold text-customCard2font">
                  Silk
                  <br />
                  Smitha
                </h2>
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            >
              <div className="p-5 flex flex-col h-full justify-between ">
                <h2 className="lg:text-4xl text-2xl font-bold text-customCard3font">
                  Fightclub
                </h2>
                <img
                  src={fightclubImage}
          ...
          <div className="flex flex-row items-center justify-center md:space-x-20">
            ...
            >
              <div className="p-5 flex flex-col h-full justify-between">
                <h2 className="lg:text-4xl text-2xl font-bold text-customCard4font">
                  Joker
                </h2>
                <img
                  src={jokerImage}
            ...
            >
              <div className="p-5 flex flex-col h-full justify-between">
                <h2 className="lg:text-4xl text-2xl font-bold text-customCard5font r-0">
                  Billie Joe
                  <br />
                  Armstrong
                </h2>
