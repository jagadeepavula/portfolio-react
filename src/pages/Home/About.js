...
import SteveImage from "../../assets/steve.gif";
...
function About() {
  ...
  return (
    <div
      id="about"
      className="relative flex flex-col h-auto justify-center items-center"
    >
      <div className="flex flex-col justify-center items-center overflow-hidden">
        <motion.img
          ...
          src={bg}
          alt=""
          className="object-cover h-auto w-5/6  overflow-x-hidden"
        />
      </div>
      <div className="w-5/6 relative">
        <p className="absolute bottom-0 right-0 bg-transparent p-2 text-white font-bold sm:text-5xl md:text-6xl lg:text-7xl text-4xl transform translate-x-1/2 translate-y-1/2">
          About.
        </p>
      </div>
      <div className="flex w-5/6 sm:mt-4 text-justify">
        ...
        <div className="lg:w-3/5 w-5/6 pt-20">
          <h1 className="font-medium text-xl sm:text-2xl leading-8 sm:leading-9 lg:leading-10 text-justify relative">
            ...
            , where the bustling streets taught me resilience and a passion for
            problem-solving.
            <br /> Now, I call&nbsp;
            <span className="font-black italic">
              <a
                href="https://www.google.com/maps?q=Sunnyvale, California"
                target="_blank"
                rel="noopener noreferrer"
                className="text-black hover:underline"
              >
            ...
            , home, where the sunny skies fuel my drive for innovation, and
            maybe someday, create something revolutionary{" "}
            <HoverImageComponent
              imageSrc={SteveImage}
              alt="Designed Image"
